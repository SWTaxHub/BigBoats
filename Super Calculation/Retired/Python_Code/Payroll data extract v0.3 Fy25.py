...
earliest_rate_change["Period Ending"] = pd.to_datetime(earliest_rate_change["Period Ending"])
...
new_order = ['Period Ending', 'Period Ending Date', 'Code_', 'Pay No.', 'Employee Name', 'Code', 'Pay Description',
