...
input_file = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Employee details\Employee_Labels.txt"
output_file = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Employee details\Employee_Labels.csv"

# File paths for Offshore employee Labels
input_file_offshore = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Employee details\Employee_Labels.txt"
output_file_offshore = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Employee details\Employee_Labels.csv"


allowance_details = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Paycode Attributes\Allowance_Details_Report.txt"
allowance_details_output = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Paycode Attributes\Allowance_Details_Report.csv"
...
allowance_details_df = pd.read_csv(
    allowance_details_output,
    encoding='latin1',
    #dtype={'Column_Name': str}  
)

#print(allowance_details_df.head)
#print(allowance_details_df.columns)


#allowance_details_df['Tax Cert. Status'] = allowance_details_df['Tax Cert. Status'].split

# Define a regex pattern to extract key parts
pattern = re.compile(r"(?P<Tax_Treatment>Before|After)\s+(?P<Tax_Cert_Type>In Tax Cert|Itemised|Not in Tax Cert)?\s*(?P<Tax_Cert_Totals>Totals)?\s*(?P<Include_Tax_Cert>Yes|No)?")

split_cols = allowance_details_df['Tax Cert. Status'].str.extract(pattern)
#split_cols =  allowance_details_df['Tax Cert. Status'].str.split(expand=True)
...
Show YTD on Pay Advice :
Allow date entry :
Multiple G/L Dissections :
Include in SG Threshold :
Back Pay :
...
def extract_allowance_details(input_file, output_file):
    """
    Extracts specific pay details from a structured text file and writes them into a CSV file.
    ...
    patterns = {
        "Type": re.compile(r"Type:\s*(?P<Type>[\w\s\(\)]+)"),
        "Min Qty": re.compile(r"Min Qty\s*=\s*(?P<Min_Qty>[\d,.]+)"),
        "Max Qty": re.compile(r"Max Qty\s*=\s*(?P<Max_Qty>[\d,.]+)"),
        "Min $": re.compile(r"Min\s+\$\s*=\s*(?P<Min_Dollar>[\d,.]+)"),
        "Max $": re.compile(r"Max\s+\$\s*=\s*(?P<Max_Dollar>[\d,.]+)"),
        "Show rate on Pay Advice": re.compile(r"Show rate on Pay Advice\s*:\s*(?P<Show_Rate>[Yes|No]+)"),
        "Show YTD on Pay Advice": re.compile(r"Show YTD on Pay Advice\s*:\s*(?P<Show_YTD>[Yes|No]+)"),
        "Allow date entry": re.compile(r"Allow date entry\s*:\s*(?P<Allow_Date>[Yes|No]+)"),
        "Multiple G/L Dissections": re.compile(r"Multiple G/L Dissections\s*:\s*(?P<Multiple_GL>[Yes|No]+)"),
        "Include in SG Threshold": re.compile(r"Include in SG Threshold\s*:\s*(?P<SG_Threshold>[Yes|No]+)"),
        "Back Pay": re.compile(r"Back Pay\s*:\s*(?P<Back_Pay>[Yes|No]+)")
    }
    ...
    for line in lines:
        ...
        # Apply all regex patterns to extract details
        for key, pattern in patterns.items():
            match = pattern.search(line)
            if match:
                current_record[key] = match.groupdict().get(key.replace(" ", "_"), "")

        # If the record has data and a new section starts, save it
        if "Type" in current_record and any(line.startswith(x) for x in ["Type:", "Min Qty =", "Min $"]):
    ...
    # Define headers
    headers = ["Type", "Min Qty", "Max Qty", "Min $", "Max $", 
               "Show rate on Pay Advice", "Show YTD on Pay Advice", 
               "Allow date entry", "Multiple G/L Dissections", 
               "Include in SG Threshold", "Back Pay"]
...
output_path = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\AllowanceDetails_Extracted.csv"

extract_allowance_details(allowance_details_df, output_path)
...
# File paths
input_file_empLeave = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Leave\Employee_Leave_History_Report 22.txt"
output_file_empLeave= r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Leave\Employee_Leave_History_Report 22.csv"
...
input_file_super22 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Super\Superannuation 22.txt"
output_file_super22 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Super\Superannuation 22.csv"


input_file_super23 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Super\Superannuation 23.txt"
output_file_super23 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Super\Superannuation 23.csv"


input_file_super24 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Super\Superannuation 24.txt"
output_file_super24 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Super\Superannuation 24.csv"




# File paths for Super 2022 - 2024 Offshore files
input_file_super22_offshore = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Super\Superannuation 22.txt"
output_file_super22_offshore =  r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Super\Superannuation 22.csv"

input_file_super23_offshore = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Super\Superannuation 23.txt"
output_file_super23_offshore = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Super\Superannuation 23.csv"

input_file_super24_offshore = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Super\Superannuation 24.txt"
output_file_super24_offshore = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO OFFSHORE\Super\Superannuation 24.csv"
...
# File paths
input_file1 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Leave\Employee_Leave_History_Report 22.txt"
output_file1 = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR\Leave\Employee_Leave_History_Report 22.csv"
