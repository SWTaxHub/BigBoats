...
Payroll_Labour_filepath = r"C:\Users\USER\OneDrive - SW Accountants\Documents\Desktop\Maritimo\Shared Folder\Payroll reports\MARITIMO LABOUR"
...
def payroll_calc(Payroll_Offshore_data, combo_Paycodes, file_suffix="LABOUR / OFFSHORE"):
   ...
   #print(merged_data.isnull().sum())  # Check for null values
    ...
    PayMap = r"C:\Users\USER\OneDrive - SW Accountants\Desktop\Maritimo\2025.05.08_PAYCODE_MAPPING.xlsx"
