...
print(Payroll_Offshore_data['PayCode'].unique())
...
merged_data.to_csv('MergedDataTest.csv')
...
#merged_data["Period_Ending"] = merged_data["Period_Ending"].astype(str)

# merged_data['SG_Rate'] = np.where(
#     merged_data['Period_Ending'].str.contains('2022', na=False), 
#     0.1,
#     np.where(
#         merged_data['Period_Ending'].str.contains('2023', na=False),
#         0.105,
#         np.where(
#             merged_data['Period_Ending'].str.contains('2024', na=False),
#             0.11,
