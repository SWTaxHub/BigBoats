...
# # Part 1 of Extract
# file_path = r"<your-downloads-folder>\Pay_Details_HistoryFY24_NewExtract_Labour_Part1 (11).txt"


# part 2 of Extract
file_path = r"<your-downloads-folder>\Pay_Details_History_labour_24_part2 (1).txt"
...
df.to_csv(r"<your-downloads-folder>\Pay_Details_History_labour_24_part2 (1).csv")


# concat Labour25_PayrollTest_part1.csv and abour25_PayrollTest_part2.csv

# Load the CSV files
df1 = pd.read_csv(r"<your-downloads-folder>\Pay_Details_History_labour_24_part1 (1).csv")
df2 = pd.read_csv(r"<your-downloads-folder>\Pay_Details_History_labour_24_part2 (1).csv")
