...
# PArt 1
#file_path = r"<your-downloads-folder>\Pay_Details_HistoryFY25_Labour_Part1.txt"
...
file_path = r"<your-downloads-folder>\Pay_Details_History_Offshore_22_23 (1).txt"
...
df.to_csv(r"<your-downloads-folder>\Pay_Details_History_Offshore_23.csv")


# concat Labour25_PayrollTest_part1.csv and abour25_PayrollTest_part2.csv

# ## Load the CSV files
# df1 = pd.read_csv(r"<your-downloads-folder>\Pay_Details_History_labour_25_part1.csv")
# df2 = pd.read_csv(r"<your-downloads-folder>\Pay_Details_History_labour_25_part2.csv")
